...
To use this module you will have to store all the dates in fixed timezone(UTC is recommended). This module will provide a view helper to display datetime according to user`s timezone.
